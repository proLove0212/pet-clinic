    ...
    <div class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style="max-width:1000px">
        <div class="md:flex w-full">
            ...
            <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                ...
                <div>
                    <form class="form-horizontal" action="{{url('/petcrew/account/password/reset_2')}}" method="POST">
                        @csrf
                        ...
                        <div class="flex -mx-3">
                            <div class="w-full px-3 mb-12">
                                <p class="text-sm mb-5">ご登録いただいたメールアドレスを入力してください。</p>
                                <p class="text-sm">メールアドレス宛にパスワード変更ページのURLが記載されたメールを送信します。</p>
                            </div>
                        </div>

                        <div class="flex -mx-3">
                            <div class="w-full px-3 mb-5">
                                <button class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">パスワード再設定メールを送信する</button>
                            </div>
                        </div>
                    </form>
                </div>
