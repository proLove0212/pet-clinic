    ...
    <div style="width:100%; max-width: 768px"
      class="block max-w-xl rounded-lg bg-white text-center shadow-lg dark:bg-neutral-700">
        ...
        <div class="mb-4 border-b border-gray-200">
            <ul class="text-sm font-medium text-center text-gray-500 divide-x divide-gray-200 rounded-lg shadow xs:flex "  id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
                <li class="w-full">
                    <a href="#" class="inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300"  id="no-tab" data-tabs-target="#no" role="tab" aria-controls="no" aria-selected="true">番号検索</a>
                </li>
                <li class="w-full">
                    <a href="#" class="inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300"  data-tabs-target="#name" role="tab" aria-controls="name" aria-selected="false">名前検索</a>
                </li>
            </ul>
        </div>
                ...
                <form action="{{url('petcrew/search')}}" method="post">
                    ...
                    <ul class="space-y-1 text-sm text-gray-700 dark:text-gray-200" >
                        <li>
                            <div class="flex items-center p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                              ...
                              <div class="ml-2 text-sm">
                                  <label for="radio_cust_no" class="font-medium text-gray-900 dark:text-gray-300">
                                    顧客番号
                                  </label>
                              </div>
                              <div class="ml-2 grow ">
                        ...
                        <li>
                            <div class="flex items-center p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                              <div class="flex items-center h-5">
                                  <input id="radio_tel_no" name="mode" type="radio" value="tel" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                              </div>
                              <div class="ml-2 text-sm">
                                  <label for="radio_tel_no" class="font-medium text-gray-900 dark:text-gray-300">
                                    電話番号
                                  </label>
                              </div>
                              <div class="ml-2 grow ">
            ...
            <div class="hidden text-left p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="name" role="tabpanel" aria-labelledby="name-tab">
                ...
                <form action="{{url('/petcrew/search')}}" method="post">
                    ...
                    <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-12">
                        ...
                        <div class="md:col-span-6">
                            <label for="address">顧客姓ふりがな</label>
                        ...
                        <div class="md:col-span-6 flex items-end">
                            ...
                            class="w-full inline-block rounded-full bg-warning px-6 pt-2.5 pb-2 text-xs font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#e4a11b] transition duration-150 ease-in-out hover:bg-warning-600 hover:shadow-[0_8px_9px_-4px_rgba(228,161,27,0.3),0_4px_18px_0_rgba(228,161,27,0.2)] focus:bg-warning-600 focus:shadow-[0_8px_9px_-4px_rgba(228,161,27,0.3),0_4px_18px_0_rgba(228,161,27,0.2)] focus:outline-none focus:ring-0 active:bg-warning-700 active:shadow-[0_8px_9px_-4px_rgba(228,161,27,0.3),0_4px_18px_0_rgba(228,161,27,0.2)]">
                            全てｸﾘｱ
                          </button>
                        </div>
                    </div>
                    <div class="mt-3 px-2">
                        <div class="inline-flex items-center">
                          <input type="checkbox" name="include_dead" id="include_dead" class="form-checkbox" />
                          <label for="billing_same" class="ml-2">死亡、失踪、譲渡のペットも検索</label>
                        </div>
                    </div>
